  ...
  onMount(async () => {
    try {
      ...
      const response = await fetch(
        "https://www.juicer.io/api/feeds/jelajahgame-id"
      );
      ...
      if (instagramPosts.length > 0) {
        ...
        instagramProfileUrl =
          firstPost.poster_url || "https://www.instagram.com/jelajahgame.id";
        instagramUsername = firstPost.poster_name || "jelajahgame.id";
        instagramProfileImage =
          firstPost.poster_image || "/Logo Jelajah Game Instagram.jpg";
      }
  ...
  <div class="instagram-feed-container mb-12">
    {#if isLoading}
      ...
      <div class="flex flex-col items-center justify-center py-16">
        <div
          class="animate-spin rounded-full h-12 w-12 border-b-2 border-jgYellow mb-4"
        ></div>
    ...
    {:else if error}
      ...
      <div class="text-center py-16 bg-red-50 dark:bg-red-900/10 rounded-lg">
        ...
        <p class="text-lg font-semibold text-red-700 dark:text-red-400 mb-2">
          {error}
        </p>
        <p class="text-sm text-muted-foreground">
          Feed Instagram tidak dapat dimuat. Coba refresh halaman.
        </p>
      </div>
          ...
          <article class="instagram-post group">
            ...
            >
              ...
              <div class="flex items-center gap-3 p-4 border-b">
                <img
                  ...
                  onerror={(e) =>
                    ((e.currentTarget as HTMLImageElement).src =
                      "/Logo Jelajah Game Instagram.jpg")}
                />
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-xs text-muted-foreground">
                    {formatDate(post.external_created_at)}
                  </p>
                </div>
                <svg
              ...
              <div class="p-4 space-y-3">
                ...
                <!-- Meta Info -->
                <div
                  class="flex items-center gap-4 text-sm text-muted-foreground pt-2 border-t"
                >
                  {#if post.like_count}
                  ...
                  {/if}
                  <span
                    class="ml-auto flex items-center gap-1 text-jgYellow font-medium group-hover:gap-2 transition-all"
                  >
                    Lihat di Instagram
    ...
    <div class="mt-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each articles as article, index}
          ...
          {@const thumbnail =
            article.thumbnail_url || getDefaultThumbnail(index)}
